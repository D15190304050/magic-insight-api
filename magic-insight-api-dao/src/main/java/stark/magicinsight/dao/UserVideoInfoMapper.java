...
public interface UserVideoInfoMapper
{
    ...
    long setVideoSummaryAndTranscriptFileNameById(@Param("id") long id, @Param("summaryFileName") String summaryFileName, @Param("transcriptFileName") String transcriptFileName);
