...
import stark.magicinsight.dto.results.CourseOverview;
...
{
    public CourseOverview courseOverviewSummarize(TranscriptAnalysis transcriptAnalysis)
    {
        ...
        courseOverView.setTotalMinutes(totalMinutes);
        ...
        courseOverView.setProportionTeacher(proportionTeacher);
        courseOverView.setProportionStudent(proportionStudent);
        courseOverView.setAiCourseOverview(transcriptAnalysis.getAiCourseOverview());
