...
import stark.magicinsight.dto.results.ContentStructure;
...
{
    public static final String SUMMARY_FILE_PREFIX = "SummaryOfVideo";
    ...
    public TranscriptSummary summarize(String transcript)
    {
        ...
        transcriptSummary.setCanSummarize(true);
